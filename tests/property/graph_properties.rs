//! Property-based tests for graph problems.
//!
//! These tests verify mathematical invariants like:
//! - Independent Set complement is Vertex Cover
//! - Solution validity preservation under subsets
