...
use problemreductions::models::misc::{BinPacking, Knapsack, PartiallyOrderedKnapsack, SubsetSum};
...
pub fn load_problem(
    ...
    match canonical.as_str() {
        ...
        "PartiallyOrderedKnapsack" => deser_opt::<PartiallyOrderedKnapsack>(data),
...
pub fn serialize_any_problem(
    ...
    match canonical.as_str() {
        ...
        "PartiallyOrderedKnapsack" => try_ser::<PartiallyOrderedKnapsack>(any),
