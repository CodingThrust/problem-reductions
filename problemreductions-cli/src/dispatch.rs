...
use problemreductions::models::misc::{BinPacking, Knapsack, MultiprocessorScheduling};
...
pub fn load_problem(
    ...
    match canonical.as_str() {
        ...
        "MultiprocessorScheduling" => deser_sat::<MultiprocessorScheduling>(data),
...
pub fn serialize_any_problem(
    ...
    match canonical.as_str() {
        ...
        "MultiprocessorScheduling" => try_ser::<MultiprocessorScheduling>(any),
        _ => bail!("{}", crate::problem_name::unknown_problem_error(&canonical)),
    }
}
