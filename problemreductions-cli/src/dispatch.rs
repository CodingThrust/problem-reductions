...
use problemreductions::models::misc::{BinPacking, Knapsack, ResourceConstrainedScheduling, SubsetSum};
...
pub fn load_problem(
    ...
    match canonical.as_str() {
        ...
        "ResourceConstrainedScheduling" => deser_sat::<ResourceConstrainedScheduling>(data),
...
pub fn serialize_any_problem(
    ...
    match canonical.as_str() {
        ...
        "ResourceConstrainedScheduling" => try_ser::<ResourceConstrainedScheduling>(any),
