...
pub fn load_problem(
    ...
    match canonical.as_str() {
        ...
        "MinimumFeedbackVertexSet" => deser_opt::<MinimumFeedbackVertexSet<SimpleGraph, i32>>(data),
...
pub fn serialize_any_problem(
    ...
    match canonical.as_str() {
        ...
        "MinimumFeedbackVertexSet" => try_ser::<MinimumFeedbackVertexSet<SimpleGraph, i32>>(any),
