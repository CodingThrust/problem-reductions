...
pub struct CreateArgs {
    ...
    /// Upper bound or length bound (for BoundedComponentSpanningForest, LengthBoundedDisjointPaths, LongestCommonSubsequence, MultipleChoiceBranching, OptimalLinearArrangement, RuralPostman, or ShortestCommonSupersequence)
    #[arg(long, allow_hyphen_values = true)]
