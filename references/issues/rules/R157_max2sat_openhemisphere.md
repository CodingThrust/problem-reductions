...
skip_reason: "MAX 2-SAT (Maximum 2-Satisfiability) is a specialization of SAT/MAX-SAT, not yet implemented as a separate model"
specialization_of: 'Satisfiability'
...
**Status:** SKIP_SPECIALIZATION — The source problem MAX 2-SAT (Maximum 2-Satisfiability) is a specialization of SAT that is not yet implemented as a separate model in the codebase. This rule will be revisited once MAX 2-SAT is available as a standalone problem type.
