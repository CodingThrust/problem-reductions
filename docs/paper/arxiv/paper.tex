...
% Placeholder for Fig 1: Scaling Wall
% \begin{figure}[t]
%   \centering
%   % \includegraphics[width=\columnwidth]{figures/scaling-wall.pdf}
%   \caption{Scaling wall. Human teams maintain quality up to $\sim$20 components, then hit convention drift, effort exhaustion, and knowledge discontinuity. Agents constrained by systematic verification break through all three barriers.}
...
% Placeholder for Fig 2: Verification Funnel
% \begin{figure}[t]
%   \centering
