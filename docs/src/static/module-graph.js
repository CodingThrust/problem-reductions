document.addEventListener('DOMContentLoaded', function() {
  ...
  var categoryColors = {
    core: '#c8f0c8',
    model_graph: '#c8c8f0',
    model_formula: '#d8c8f0',
    model_set: '#f0c8c8',
    model_algebraic: '#f0f0a0',
    model_misc: '#f0c8e0',
    rule: '#f0d8b0',
    registry: '#b0e0f0',
    solver: '#d0f0d0',
  ...
  var categoryBorders = {
    core: '#4a8c4a',
    model_graph: '#4a4a8c',
    model_formula: '#6a4a8c',
    model_set: '#8c4a4a',
    model_algebraic: '#8c8c4a',
    model_misc: '#8c4a6a',
    rule: '#8c6a4a',
    registry: '#4a6a8c',
    solver: '#4a8c6a',
  ...
  var fixedPositions = {
    ...
    'variant':         { x: 80, y: 380 },
    'topology':        { x: 80, y: 530 },
    // Models (center, spread across)
    'models/graph':    { x: 340, y: 80 },
    'models/formula':  { x: 340, y: 250 },
    'models/set':      { x: 340, y: 380 },
    'models/algebraic':{ x: 340, y: 500 },
    'models/misc':     { x: 540, y: 350 },
