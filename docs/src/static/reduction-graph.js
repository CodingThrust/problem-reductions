        ...
        cy.on('mouseover', 'edge', function(evt) {
          ...
          if (d.sizeFields && d.sizeFields.length > 0) {
            html += '<br>' + d.sizeFields.map(function(o) {
              ...
              if (o.contract === 'bound-only') return '<code>' + o.field + '</code> &le; <code>' + o.formula + '</code> (certified bound)';
        ...
        cy.on('tap', 'edge', function(evt) {
          ...
          if (d.sizeFields && d.sizeFields.length > 0) {
            text += '  |  ' + d.sizeFields.map(function(o) {
              ...
              if (o.contract === 'bound-only') return o.field + ' <= ' + o.formula + ' (certified bound)';
