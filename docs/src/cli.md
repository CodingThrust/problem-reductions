...
pred create MultiprocessorScheduling --lengths 4,5,3,2,6 --num-processors 2 --deadline 10 -o mps.json
...
> Some problems (e.g., QUBO, SpinGlass, MaxCut, CircuitSAT, MultiprocessorScheduling) do not have this path yet.
