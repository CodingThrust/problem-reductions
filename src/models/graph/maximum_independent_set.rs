...
impl<G, W> ConstraintSatisfactionProblem for MaximumIndependentSet<G, W>
where
    G: Graph,
    W: Clone
        + Default
...
impl<G, W> crate::traits::ProblemV2 for MaximumIndependentSet<G, W>
where
    G: Graph,
    W: Clone
        + Default
...
impl<G, W> crate::traits::OptimizationProblemV2 for MaximumIndependentSet<G, W>
where
    G: Graph,
    W: Clone
        + Default
