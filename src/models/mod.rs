...
pub use algebraic::{
    ...
    QuadraticAssignment, QuadraticDiophantineEquations, SimultaneousIncongruences,
...
pub use graph::{
    ...
    IntegralFlowWithMultipliers, IsomorphicSpanningTree, KClique, KColoring, Kernel,
    KthBestSpanningTree, LengthBoundedDisjointPaths, LongestCircuit, LongestPath, MaxCut,
    MaximalIS, MaximumAchromaticNumber, MaximumClique, MaximumIndependentSet, MaximumMatching,
    MinMaxMulticenter, MinimumCoveringByCliques, MinimumCutIntoBoundedSets, MinimumDominatingSet,
    MinimumDummyActivitiesPert, MinimumFeedbackArcSet, MinimumFeedbackVertexSet,
    MinimumGeometricConnectedDominatingSet, MinimumIntersectionGraphBasis, MinimumMaximalMatching,
    MinimumMultiwayCut, MinimumSumMulticenter, MinimumVertexCover, MixedChinesePostman,
    MonochromaticTriangle, MultipleChoiceBranching, MultipleCopyFileAllocation,
    OptimalLinearArrangement, PartialFeedbackEdgeSet, PartitionIntoCliques, PartitionIntoForests,
...
pub use misc::{
    ...
    KthLargestMTuple, LongestCommonSubsequence, MinimumExternalMacroDataCompression,
    MinimumInternalMacroDataCompression, MinimumTardinessSequencing, MultiprocessorScheduling,
    NonLivenessFreePetriNet, Numerical3DimensionalMatching, PaintShop, Partition,
    ...
    ThreePartition, TimetableDesign,
};
pub use set::{
