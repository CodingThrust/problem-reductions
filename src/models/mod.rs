...
pub use misc::{
    ...
    ExpectedRetrievalCost, Factoring, FlowShopScheduling, GroupingBySwapping, IntExpr,
    IntegerExpressionMembership, JobShopScheduling, Knapsack, LongestCommonSubsequence,
