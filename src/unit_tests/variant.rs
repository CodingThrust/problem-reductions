...
impl_variant_param!(TestChild, "test_cat");
...
impl_variant_param!(TestKChild, "test_k", k: Some(3));
...
use crate::topology::{BipartiteGraph, PlanarGraph, SimpleGraph, UnitDiskGraph};
