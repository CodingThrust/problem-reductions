...
fn example_instance() -> MinimumCutIntoBoundedSets<SimpleGraph, i64> {
...
fn test_minimumcutintoboundedsets_serialization() {
    ...
    let deserialized: MinimumCutIntoBoundedSets<SimpleGraph, i64> =
...
fn test_minimumcutintoboundedsets_variant() {
    let variant = MinimumCutIntoBoundedSets::<SimpleGraph, i64>::variant();
