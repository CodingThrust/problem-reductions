    ...
    Extract: Fn(&[usize]) -> Vec<usize>,
{
    ...
    let reference_solutions: HashSet<Vec<usize>> = solver
    ...
    Extract: Fn(&[usize]) -> Vec<usize>,
{
    ...
    let total = <BruteForce as crate::solvers::Solver>::solve(&BruteForce::new(), source).unwrap();
    for source_solution in &extracted {
